...
import './CCPPProgramming.css'; // Import CSS for styling
...
const CCPPProgramming = ({ courseDetails }) => {
  // Default course details (can be overridden by props)
  const defaultCourseDetails = {
    title: 'C/C++ Programming Course',
    description:
      'Master the fundamentals of C and C++ programming languages. Learn to write efficient, high-performance code for software development, game development, and system programming. This course covers everything from basic syntax to advanced concepts like pointers, memory management, and object-oriented programming.',
    image: '/images/cpp.jpg', // Path to the course image
    oldPrice: '₹15,000',
    newPrice: '₹10,000',
    discount: '33% off', // Optional discount
    duration: '10 Weeks',
    instructor: {
      name: 'Alex Johnson',
      bio: 'Alex is a senior software engineer with over 12 years of experience in C/C++ development. He has worked on high-performance systems and game engines.',
    ...
    syllabus: [
      ...
      'Advanced C++ Concepts (Templates, STL)',
      'Final Project: Build a Console Application',
    ],
    benefits: [
      'Hands-on coding exercises and projects',
      'Learn from industry experts with real-world experience',
      'Get certified and enhance your programming skills',
    ...
    testimonials: [
      {
        name: 'Raj',
        review: 'This course helped me understand the core concepts of C/C++ and apply them in real-world projects. Highly recommended!',
        rating: 5,
      },
      {
        name: 'Arman Siddiqui',
        review: 'The instructors are amazing, and the course content is well-structured. I landed a job as a C++ developer after completing this course!',
        rating: 5,
      },
    ],
    faqs: [
      {
        ...
        answer: 'No prior programming experience is required. Beginners are welcome!',
      },
      {
...
export default CCPPProgramming;